...
function CartInfoPlace(props) {
  ...
  let parameter = `MerchantID=MS121481874&RespondType=JSON&TimeStamp=1631867195&Version=1.5&MerchantOrderNo=1631867195&Amt=75&ItemDesc=TEST&Email=eagle20064%40icloud.com`
  ...
  function create_mpg_sha_encrypt() {
    ...
    const shaa = sha256(plainText).toUpperCase()
    ...
    <>
      ...
      <div className="cartMain cartMainRWD">
        ...
        >
          ...
          <input type="text" name="TimeStamp" value="1631867195" />
          <input type="text" name="Version" value="1.5" />
          <input type="text" name="MerchantOrderNo" value="1631867195" />
          <input type="text" name="Amt" value="75" />
